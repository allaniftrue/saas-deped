...
//                if($this->mlib_sec->validate($password,$hashed_password)) {

                 $db_data = array(
                                 'usr_email'=> $email,
                                 'usr_password'=> $hash_parts[3],
                                 'usr_salt'=> $hash_parts[2],
    ...
    function auth() {
        ...
        if($num_res === 1) {
            ...
            $result = $query->result();
            $format = PBKDF2_HASH_ALGORITHM.":".PBKDF2_ITERATIONS.":".$result[0]->usr_salt.":".$result[0]->usr_password;
