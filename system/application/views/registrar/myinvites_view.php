...
<section class="span11">
    <div class="page-header">
            <h1>List of Users Invited</h1>
    </div>
    <div class="alert alert-info">
        <strong>Notes:</strong> Expired invitations are not shown
    </div>
                    ...
                    ?>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);" id="resend" data-id="<?=$list[$i]->inv_user?>" title="Resend the activation link"><i class="icon-envelope"></i> Resend invitation</a>
                                    </li>
                                </ul><img src="<?=base_url()?>img/ajax-loader.gif" class="hide" id="img<?=$list[$i]->inv_user?>" />
                            </div>
