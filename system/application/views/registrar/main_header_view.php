...
<html lang="en">
    <head>
        ...
        <link href="<?=base_url()?>css/jquery-ui-1.9.1.custom.css" rel="stylesheet">
...
<!--            <form class="navbar-search pull-right" action=""> 
            ...
            <ul class="nav pull-right"> 
              ...
              <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                      <li><a href="<?=base_url()?>?mc=account&t=1&sess=<?=random_string('alnum', 64).'&k='.random_string('alnum', 32); ?>"><i class="icon-cogs"></i> Account Settings</a></li>
                      <li class="divider"></li>
                      <li><a href="<?=base_url()?>?mc=logout"><i class="icon-signout"></i> Logout</a></li>
                  </ul>
              </li>
          </ul>
      </div>
