...
<section id="expwrap">
    <div class="span11">
         <div class="page-header">
             <h1>Student Profile <small><strong>SY <span id="syInfo"><?=date('Y', strtotime($cursy[0]->sy_from))?> - <?=date('Y', strtotime($cursy[0]->sy_to))?></span></strong></small></h1>
         </div>
    </div>
<div class="span12" > 
        <?php 
        ...
        <div class="span5">
            <p>
                <div id="profile-pic-wrapper" class="thumbnail">
                    <img src="<?=base_url()?>img/<?=! empty($std_info[0]->std_photo) ? $std_info[0]->std_photo : 'user.png'?> " />
                </div>
            </p>
            <p>
